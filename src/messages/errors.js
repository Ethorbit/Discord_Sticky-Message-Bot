module.exports = new Object({
    ...
    "invalid_message" : "You need to pass a Discord message (!sticky add 798815345905106945 This is the missing message :D)",
    "no_stickies_channel" : "There are no stickies for that channel.",
